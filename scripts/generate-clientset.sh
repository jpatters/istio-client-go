...
SRC_DIR=$GOPATH/src
CLIENT_DIR=$SRC_DIR/github.com/jpatters/istio-client-go
...
$CODE_GEN/generate-groups.sh all \
  github.com/jpatters/istio-client-go/pkg/client github.com/jpatters/istio-client-go/pkg/apis \
  "networking:v1alpha3, authentication:v1alpha1, rbac:v1alpha1" \
  --output-base $CLIENT_DIR/../../.. \
  --go-header-file $CLIENT_DIR/jpatters-boilerplate.go.txt
